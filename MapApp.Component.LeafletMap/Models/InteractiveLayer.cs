...
namespace MapApp.Component.LeafletMap.Models
{
    ...
    {
        /// <summary>
        /// If false, the layer will not emit mouse events and will act as a part of the underlying map. (events currently not implemented in AroundMe.Online.LeafletMap)
        /// </summary>
